...
fun WeatherPage() {
    ...
    LoadingPage(
        ...
        Box(Modifier.fillMaxSize()) {
            Image(
                painter = painterResource(com.example.composepractice.R.mipmap.biz_news_local_weather_bg_big),
            ...
            Column(
                ...
                TitleBar(text = stringResource(id = com.example.composepractice.R.string.actual_weather_title))
